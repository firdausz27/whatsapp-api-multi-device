							...
							<div class="card-extra">
								<div class="dropdown dropleft">
									<a href="#" role="button" id="else" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<img src="<?= base_url() ?>/assets/template/img/svg/more-horizontal.svg" alt="more-horizontal" class="svg" />
									</a>
						...
						<div class="card-body pt-0 pb-25 mt-n10">
							<div class="label-detailed">
								<div class="label-detailed__single">
									<span class="label-detailed__type label-detailed__type--primary">Orders</span>
									<strong class="label-detailed__total">$8,550</strong>
									<span class="label-detailed__status color-success"><img class="svg" src="<?= base_url() ?>/assets/template/img/svg/arrow-success-up.svg" alt="" /><strong>25%</strong></span>
								</div>
								<div class="label-detailed__single">
									<span class="label-detailed__type label-detailed__type--info">Sales</span>
									<strong class="label-detailed__total">$5,550</strong>
									<span class="label-detailed__status color-danger"><img class="svg" src="<?= base_url() ?>/assets/template/img/svg/arrow-danger-down.svg" alt="" />
							...
							<div class="tab-content">
								<div class="tab-pane active show" id="salesgrowth" role="tabpanel" aria-labelledby="salesgrowth-tab">
									<div class="label-detailed label-detailed--two">
										<div class="label-detailed__single">
											<strong class="label-detailed__total">$8,550</strong>
											<span class="label-detailed__status color-success"><img class="svg" src="<?= base_url() ?>/assets/template/img/svg/arrow-success-up.svg" alt="" />
											...
											<table class="table table--default table-borderless">
												...
												<tbody>
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="radius-xs img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/premium-clock.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="radius-xs img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/t-shirt.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="radius-xs img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/nike.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="radius-xs img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/cup-glass.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="radius-xs img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/women-bag.png" alt="img" />
																<span>Women Bag</span>
															</div>
														</td>
														<td>$32</td>
											...
											<table class="table table--default table-borderless">
												...
												<tbody>
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/287.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="me-15 wh-34 img-fluid" src="<?= base_url() ?>/assets/template/img/165.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/166.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/315.png" alt="img" />
													...
													<tr>
														<td>
															<div class="selling-product-img d-flex align-items-center">
																<img class="me-15 wh-34 img-fluid order-bg-opacity-primary" src="<?= base_url() ?>/assets/template/img/506.png" alt="img" />
